...
#' # Hipótesis -> H0: F(G1) = F(G2) = F(G3) vs H1: Al menos un F(Gi) es diferente
...
#' library(agricolae)
#' # Hipótesis -> H0: Me1 = Me2 = Me3 vs H1: Al menos una Mei es diferente
...
#' # Hipótesis -> H0: Me1 = Me2 = Me3 vs H1: Me1 <= Me2 <= Me3 (al menos una estricta)
...
#' 06. Levene (Escala)
#' library(lawstat)
#' # Hipótesis -> H0: var1 = var2 = var3 vs H1: Al menos una varianza es diferente
#' levene.test(y, g)
...
#' # Hipótesis -> H0: p1 = p2 = p3 vs H1: Al menos una p_i es diferente
...
#' # Hipótesis -> H0: Me1 = Me2 = Me3 = Me4 vs H1: Al menos una Mei es diferente
...
#' # Hipótesis -> H0: No hay efecto del factor A / factor B / interacción AxB
